...
public class CodeUtil {
    ...
    // 随机产生的字符串
    private static final String RANDOM_STRS = "1234567890abcdefghijklmnopqrstuvwxyz";
     ...
     * @throws IOException
     */
    public static void genRandomCodeImage(HttpServletResponse response, HttpSession session){
